...
function Nav() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/85 backdrop-blur-md shadow-sm" style={{ borderColor: theme.border }}>
      <div className="max-w-6xl mx-auto flex items-center justify-between px-6 py-3">
        <button onClick={() => go("home")} className="text-lg font-semibold tracking-wide" style={{ color: theme.primary }}>
          The Dancing Queen
        </button>
        ...
        <button className="md:hidden flex flex-col gap-1.5 p-2" onClick={() => setMobileOpen(!mobileOpen)} aria-label="Toggle menu">
          <span className={`block w-6 h-0.5 transition-all duration-300 ${mobileOpen?"rotate-45 translate-y-2":""}`} style={{background:theme.primary}} />
          <span className={`block w-6 h-0.5 transition-all duration-300 ${mobileOpen?"opacity-0":""}`} style={{background:theme.primary}} />
          <span className={`block w-6 h-0.5 transition-all duration-300 ${mobileOpen?"-rotate-45 -translate-y-2":""}`} style={{background:theme.primary}} />
        </button>
      </div>
      {mobileOpen && (
...
/* ═══════════════════════════════════════════════════
   HOME PAGE — Video hero, text appears on scroll
   ═══════════════════════════════════════════════════ */
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <Reveal><div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl max-w-3xl mx-auto leading-relaxed" style={{ color: theme.mutedFg }}>
            The Dancing Queen invents a new piece of children&apos;s mythology — a tiny, light, fairy-like being with wings who lives in a child&apos;s hair. By day she plays in backyards; as evening falls, she tucks her wings in close and stands guard over their dreams.
          </p>
        </div></Reveal>
          ...
          <Reveal delay={200}>
            <div>
              ...
              <div className="space-y-5 leading-relaxed" style={{ color: theme.mutedFg }}>
                <p>Known to her grandsons as <strong style={{ color: theme.primary }}>Mémère</strong> — the French word for grandmother — the author wrote <em>The Dancing Queen</em> as a bedtime gift for George and Myles, whom she affectionately calls &ldquo;Critter and Bug.&rdquo; What began as a personal lullaby grew into a story she wanted to share with every child who still looks for a little magic before saying good night.</p>
                <p>In her dedication, Mémère writes about a love that has no words — the love for a mother and father, the love that completes your life, the love that explodes your heart when you hold your newborn child. But she reserves her most awe-filled words for grandchildren.</p>
                <p>This book is that feeling, distilled into verse and illustration — a grandmother&apos;s love letter to the wonder of childhood, and to the tiny guardians who watch over our children&apos;s dreams.</p>
              </div>
              <div className="mt-8">
                <p className="font-semibold text-lg" style={{ color: theme.primary }}>&ldquo;Love you to the moon and back&rdquo;</p>
                <p style={{ color: theme.accent }}>— Mémère</p>
              </div>
            </div>
          </Reveal>
        </div>
      ...
      <div className="max-w-3xl mx-auto text-center relative z-10">
        <Reveal>
          ...
          <p className="text-lg text-white/80 max-w-xl mx-auto mb-10 leading-relaxed">
            The Dancing Queen is more than a bedtime story — it is a grandmother&apos;s love letter to the wonder of childhood, and to the tiny guardians who watch over our children&apos;s dreams.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <p className="text-white/40 text-sm mt-12 italic">&ldquo;To Every Child who believes in tiny wonders…&rdquo;</p>
        </Reveal>
      </div>
    </div>
  );
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-sm leading-relaxed opacity-70">A whimsical bedtime picture book by Mémère. Dedicated to George and Myles — and to every child who still looks for a little magic before saying good night.</p>
          </div>
          <div>
